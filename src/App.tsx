...
function ReferenceScrollVisuals() {
  return <>
    <RevealSection className="reference-services" id="المميزات"><div className="reference-services-inner"><img src="/legal-workspace-section.png" alt="مساحة عمل قانونية متكاملة تعرض تحليل المستندات والمخاطر والمساعد القانوني" /></div></RevealSection>
...
function CTA() { return <section className="cta" id="ابدأ"><div className="cta-stamp"><Sparkles size={21}/></div><span className="eyebrow light">Counsel AI</span><h2>ابدأ مستقبل العمل<br/>القانوني اليوم.</h2><p>قلل الأعمال المتكررة، وافهم مستنداتك بشكل أسرع، وامنح فريقك مساحة أكبر للعمل عالي القيمة.</p><Button>ابدأ الآن</Button><small>لا تتخذ المنصة قرارات قانونية نيابةً عنك.</small></section> }
