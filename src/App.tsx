...
function ProductShowcase() { return <section className="section product-showcase"><div className="product-showcopy"><span className="eyebrow">تجربة المنتج</span><h2>شاهد الذكاء القانوني<br/>أثناء العمل.</h2><p>تتحول المستندات إلى مساحة عمل تضع البنود المهمة، مستوى المخاطر، والإجراء المقترح في متناولك.</p><div className="showcase-stats"><span><b>٤</b> بنود للمراجعة</span><span><b>متوسط</b> مستوى المخاطر</span></div><Button secondary>استكشف تجربة التحليل</Button></div><div className="product-3d-shell"><video className="product-demo-video" autoPlay muted loop playsInline preload="metadata" aria-label="عرض توضيحي لمساحة العمل القانونية"><source src="/legal-ai-demo.mp4" type="video/mp4" /></video><div className="product-status"><span className="status-dot"/> اكتمل التحليل</div><div className="product-clause">بند المسؤولية <b>يحتاج إلى مراجعة</b></div></div></section> }
