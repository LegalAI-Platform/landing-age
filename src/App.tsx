...
function ReferenceScrollVisuals() {
  return <>
    <RevealSection className="reference-services" id="المميزات"><div className="reference-services-inner"><img src="/legal-workspace-section-clean.png" alt="مساحة عمل قانونية متكاملة تعرض تحليل المستندات والمخاطر والمساعد القانوني" /><a className="reference-image-cta" href="#ابدأ" aria-label="استكشف المنصة">استكشف المنصة</a></div></RevealSection>
